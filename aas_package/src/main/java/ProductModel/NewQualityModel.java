...
class QualityInstance extends Quality{
    String URI;
    List<Process> processes;

    public QualityInstance(String idShort, String description, )
}

public class NewQualityModel{
    public static Map<AssetAdministrationShell, List<Submodel>> createAASforQuality(ProcedureInstance procedure,
        String idShort,
        String description) {
